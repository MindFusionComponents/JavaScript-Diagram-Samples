<template>
  <div class="App">
    <div class="header">
      <select id="shape" v-on:change="onShapeChanged($event)">
    ...
    <div class="container">
      ...
      <div class="sidebar">
        ...
        <p>
          ...
          Link several boxes with arrows to get an idea how anchor points work.
        </p>
        <Info />
      </div>
    </div>
...
export default {
  ...
  created: function() {
    ...
    this.apat2 = new mf.Diagramming.AnchorPattern([
      new mf.Diagramming.AnchorPoint(
        10,
        0,
        true,
        false,
        mf.Diagramming.MarkStyle.Circle,
        green
      ),
      new mf.Diagramming.AnchorPoint(
        50,
      ...
      new mf.Diagramming.AnchorPoint(
        ...
        false,
        true,
        mf.Diagramming.MarkStyle.Rectangle
      ),
      new mf.Diagramming.AnchorPoint(
        50,
        100,
      ...
      new mf.Diagramming.AnchorPoint(
        ...
        true,
        true,
        mf.Diagramming.MarkStyle.X
      )
    ]);

    var pb1 = diagram
      .getFactory()
      .createShapeNode(new mf.Drawing.Rect(10, 7, 25, 18));
    ...
    var pb2 = diagram
      .getFactory()
      .createShapeNode(new mf.Drawing.Rect(20, 78, 25, 18));
    pb2.setText("node 1");
    pb2.setAnchorPattern(this.apat2);

    var pb3 = diagram
      .getFactory()
      .createShapeNode(new mf.Drawing.Rect(70, 73, 25, 18));
    pb3.setText("node 2");
    pb3.setAnchorPattern(this.apat2);

    var pb4 = diagram
      .getFactory()
      .createShapeNode(new mf.Drawing.Rect(80, 110, 25, 18));
    pb4.setShape("Ellipse");
    pb4.setText("End");
    pb4.setAnchorPattern(apat1);

    this.decision1In3Out = mf.Diagramming.AnchorPattern.fromId(
      "Decision1In3Out"
    );

    var decb1 = diagram
      .getFactory()
      .createShapeNode(new mf.Drawing.Rect(20, 35, 30, 20));
    decb1.setShape("Decision");
    decb1.setText("check 1");
    decb1.setAnchorPattern(this.decision1In3Out);

    var decision2In2Out = mf.Diagramming.AnchorPattern.fromId(
      "Decision2In2Out"
    );

    var decb2 = diagram
      .getFactory()
      .createShapeNode(new mf.Drawing.Rect(70, 30, 30, 20));
  ...
  methods: {
    ...
    onDiagramNodeCreated: function(sender, args) {
      ...
      else node.setAnchorPattern(this.decision1In3Out);
    }
  },
  data() {
    return {
