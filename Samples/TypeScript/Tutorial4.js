...
(function (Tutorial4) {
    ...
    Tutorial4.TemplatedBase = CompositeNode.classFromTemplate("TemplatedBase", {
        component: "GridPanel",
        rowDefinitions: ["*"],
    ...
    Tutorial4.OrgChartNode = function (parent) {
        AbstractionLayer.initializeBase(Tutorial4.OrgChartNode, this, [parent]);
        this.cost = "low";
    };
    Tutorial4.OrgChartNode.prototype =
        {
            getCost: function () {
                return this.cost;
            },
            ...
            clone: function () {
                var copy = AbstractionLayer.callBaseMethod(Tutorial4.OrgChartNode, this, "clone", []);
                copy.cost = this.cost;
                return copy;
            },
            // clipboard and serialization support
            toJson: function () {
                var json = AbstractionLayer.callBaseMethod(Tutorial4.OrgChartNode, this, "toJson", []);
                json.cost = this.cost;
                return json;
            },
            fromJson: function (json) {
                AbstractionLayer.callBaseMethod(Tutorial4.OrgChartNode, this, "fromJson", [json]);
                this.cost = json.cost;
            },
            // undo/redo
            saveState: function () {
                var state = AbstractionLayer.callBaseMethod(Tutorial4.OrgChartNode, this, "saveState", []);
                state.cost = this.cost;
                return state;
            },
            restoreState: function (state) {
                AbstractionLayer.callBaseMethod(Tutorial4.OrgChartNode, this, "restoreState", [state]);
                this.cost = state.cost;
            }
        };
    Tutorial4.diagram = null;
    var nodeListView = null;
    $(document).ready(function () {
        AbstractionLayer.registerClass(Tutorial4.OrgChartNode, "Tutorial4.OrgChartNode", Tutorial4.TemplatedBase);
        // create a Diagram component that wraps the "diagram" canvas
        Tutorial4.diagram = Diagram.create($("#diagram")[0]);
        // enable undo/redo support
        Tutorial4.diagram.setUndoEnabled(true);
        // enable drawing of custom nodes interactively
        Tutorial4.diagram.setCustomNodeType(Tutorial4.OrgChartNode);
        Tutorial4.diagram.setBehavior(Behavior.Custom);
        ...
        node1.setDetails("Vacation in the snow. \r\n" +
