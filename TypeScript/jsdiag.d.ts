...
declare namespace MindFusion.Diagramming
{
	...
	class Diagram extends MindFusion.Drawing.Canvas
	{
		...
		*/
		...
		setLinkBaseShapeSize(value: number);
		...
		setBackgroundImageContent(value: string);
		...
		*/
		...
		setModificationStart(value: ModificationStart);
		...
		*/
		...
		setAllowMultipleResize(value: boolean);
		...
		setAllowUnconnectedLinks(value: boolean);
		...
		setLinkTextStyle(value: LinkTextStyle);
		...
		setAdjustmentHandlesSize(value: number);
		...
		setShowDisabledHandles(value: boolean);
		...
		setShowAnchors(value: ShowAnchors);
		...
		*/
		...
		setExpandOnIncoming(value: boolean);
		...
		setNodesExpandable(value: boolean);
		...
		setVirtualScroll(value: boolean);
		...
		setLinkHitDistance(value: number);
		...
		setLinkCrossings(value: LinkCrossings);
		...
		setCrossingRadius(value: number);
		...
		setRoundedLinksRadius(value: number);
		...
		setAutoResize(value: AutoResize);
		...
		setScrollZoneSize(value: number);
		...
		setAutoScrollAmount(value: number);
		...
		setMagnifierShading(value: boolean);
		...
		setMagnifierSecondaryFrameColor(value: string);
		...
		*/
		...
		setLeftButtonActions(value: MouseButtonActions);
		...
		setMiddleButtonActions(value: MouseButtonActions);
		...
		setShadowsStyle(value: ShadowsStyle);
		...
		setShapeLibraryLocation(value: string);
	...
	class Style
	{
		...
		setFontStyle(value: MindFusion.Drawing.FontStyle);
		...
		setNodeEffects(value: Array<NodeEffect>);
	}
	...
	class AnchorPattern
	{
		...
		*/
		...
		setPoints(value: Array<AnchorPoint>);
	...
	class AnchorPoint
	{
		...
		*/
		...
		setAllowIncoming(value: boolean);
	...
	class GlassEffect extends NodeEffect
	{
		...
		setReflectionColor(value: string);
	}
	...
	class AeroEffect extends NodeEffect
	{
		...
		setInnerOutlineColor(value: string);
	}
	...
	class NodeListView extends MindFusion.Drawing.Canvas
	{
		...
		*/
		...
		setDefaultNodeSize(value: MindFusion.Drawing.Size);
		...
		setIconSize(value: MindFusion.Drawing.Size);
